...
function Start(){
      ...
      function GameOnClose() {
          console.log("connection to game server closed")
          central_ws.send("newGame");
          console.log("sent request for new game server to central server")
      }
      ...
      central_ws.onmessage = function(event) {
          ...
          game_ws = new WebSocket("ws://unix5.andrew.cmu.edu:" + gs_port + "/");
          
          game_ws.onopen = GameOnOpen;
          
          game_ws.onmessage = GameOnMessage;
          
          game_ws.onclose = GameOnClose;
      }
